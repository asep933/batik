    ...
    <div className="bg-black text-fourth" id="footer">
      <footer className="footer p-10 bg-black text-base-conten">
        ...
        <nav>
          ...
          <a className="hover:text-third cursor-pointer">084-473-672-372</a>
          <a className="hover:text-third cursor-pointer">
            batiknaional@gmail.com
          </a>
          <a className="hover:text-third cursor-pointer">
            www.batiknasional.com
          </a>
        </nav>
        <nav>
          <h6 className="footer-title">Legal</h6>
          <a className="hover:text-third cursor-pointer">Terms of use</a>
          <a className="hover:text-third cursor-pointer">Privacy policy</a>
          <a className="hover:text-third cursor-pointer">Cookie policy</a>
        </nav>
      </footer>
      <footer className="footer px-10 py-4 border-t bg-black text-fourth border-base-300">
